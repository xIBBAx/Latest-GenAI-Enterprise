...
//             const res = await fetch("/api/basic/generate-usage-report", {
//                 method: "POST",
//                 credentials: "include",
//                 headers: {
...
//                 `/api/basic/usage-report/${report.report_name}`
//             );
...
// const USAGE_REPORT_URL = "/api/basic/usage-report";
...
//                                     <TableCell>
//                                         <Link
//                                             href={`/api/basic/usage-report/${r.report_name}`}
