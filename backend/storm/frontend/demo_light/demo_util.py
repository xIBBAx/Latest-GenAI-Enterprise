...
def set_storm_runner():
    ...
    llm_configs.question_asker_lm = openai_model
    llm_configs.outline_generation_lm = openai_model
    llm_configs.article_generation_lm = openai_model
    llm_configs.article_polishing_lm = openai_model
    ...
    rm = SearXNG(
        searxng_api_url=st.secrets["SEARXNG_URL"],
